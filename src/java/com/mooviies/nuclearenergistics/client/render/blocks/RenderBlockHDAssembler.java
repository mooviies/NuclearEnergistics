package com.mooviies.nuclearenergistics.client.render.blocks;

import java.util.EnumSet;

import com.mooviies.nuclearenergistics.block.BlockHDMolecularAssembler;
...
public class RenderBlockHDAssembler extends BaseBlockRender<BlockHDMolecularAssembler, TileHDMolecularAssembler> implements IBoxProvider
{

	public RenderBlockHDAssembler()
	{
		super( false, 20 );
	}

	@Override
	public void renderInventory( final BlockHDMolecularAssembler blk, final ItemStack is, final RenderBlocks renderer, final ItemRenderType type, final Object[] obj )
	{
	...
	@Override
	public boolean renderInWorld( final BlockHDMolecularAssembler maBlock, final IBlockAccess world, final int x, final int y, final int z, RenderBlocks renderer )
	{
		final TileHDMolecularAssembler tma = maBlock.getTileEntity( world, x, y, z );

		if( BlockHDMolecularAssembler.isBooleanAlphaPass() )
		{
			if( tma.isPowered() )
			{
	...
	private void renderCableAt( final double thickness, final IBlockAccess world, final int x, final int y, final int z, final BlockHDMolecularAssembler block, final RenderBlocks renderer, final double pull, final boolean covered )
	{
		IIcon texture = null;
